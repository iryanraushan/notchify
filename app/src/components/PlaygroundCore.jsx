...
export default function PlaygroundCore({
  ...
  const [iconOpt, setIconOpt] =
    useState("none");

  const [closeCorner, setCloseCorner] =
    useState("left");

  const [closeButtonSize, setCloseButtonSize] =
    useState(16);

  const [closeButtonOffset, setCloseButtonOffset] =
    useState(50);

  const [actionEnabled, setActionEnabled] =
    useState(false);
...
${opts.join(",\n")}
  ...
  const fire = () => {
    ...
    if (iconOpt !== "none") {
      ...
      if (
        ...
        opts.closeButtonStyle =
          getFloatingCloseButtonStyle(
            closeCorner,
            closeButtonSize,
            closeButtonOffset
          );
  ...
  return (
    <div
      className={`grid ${
        compact
          ? "lg:grid-cols-[260px_minmax(320px,440px)_320px]"
          : "lg:grid-cols-[300px_minmax(340px,460px)_420px]"
      } grid-cols-1 gap-4 lg:justify-center`}
    ...
    >
      ...
      >
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="mt-1 text-[10px] font-mono text-[#737373]">
              This updates the live ToastProvider used by the preview.
            </p>
          </div>
      ...
      {/* PREVIEW */}
      <div
        className={`${PANEL} soft-reflection p-5 flex flex-col items-center justify-center min-h-[420px] relative overflow-hidden w-full`}
        data-testid="playground-preview"
      >
        <div className="absolute inset-0 bg-grid-dots opacity-60" />

        <div className="relative text-center">
          <div className="font-mono text-[10px] uppercase tracking-widest text-[#737373] mb-3">
            Live preview
          </div>
          ...
          <p className="mt-4 text-xs text-[#737373] font-mono">
            Click to fire with current config.
          </p>
        </div>
      </div>
